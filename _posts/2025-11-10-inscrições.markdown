...
{: .prompt-warning}
> O prazo para solicitação de bolsa está encerrado.
{: .prompt-danger}
...
<p style='text-align: justify;text-justify: inter-word;'>
    ...
    <a href='https://uspdigital.usp.br/apolo/apoObterCurso?cod_curso=550300012&cod_edicao=25004&numseqofeedi=1' target="_blank">Mais informações sobre o curso</a><br><br>

    As inscrições deverão ser feitas entre os dias 03/12/2025 e 08/03/2025 através do link a seguir:<br>
    <a href='https://fealq.org.br/cursos/curso-de-atualizacao-estatistica-e-otimizacao-para-ciencia-de-dados-e-pesquisa-operacional/' target="_blank">Clique para abrir o site de inscrição</a>
</p>

### 1.2. Documentação

<p style='text-align: justify;text-justify: inter-word;'>
    Todos os documentos solicitados pelo sistema de inscrição são obrigatórios, exceto o "Documento específico", o "Currículo" e o "Histórico escolar de graduação". O documento específico é opcional para o caso de você desejar incluir mais informações que achar relevantes e o histórico e o currículo servem para auxiliar na classificação e ajudam a conhecer melhor a formação das/dos alunas/alunos. Veja a lista completa dos documentos a seguir:
    <ol>
        <li>Documento de identificação: RG, Habilitação, RNE (ou protocolo), Passaporte, etc.</li>
        <li>CPF (exceto para estrangeiros)</li>
        <li>Diploma de graduação ou histórico escolar de curso de graduação em andamento</li>
...
<p style='text-align: justify;text-justify: inter-word;'>
    Para participar do processo de seleção, deve ser paga uma taxa de inscrição de R$100,00. Os inscritos que forem selecionados precisam pagar uma taxa de matrícula de R$150,00 para manifestar interesse no curso. A partir daí, serão três mensalidades de R$416,00. Em resumo, os valores desembolsados serão:
        <ul>
            <li>Valor da inscrição: R$100,00</li>
            <li>Valor da matrícula: R$150,00</li>
            <li>Valor do curso: R$1.248,00
                <ul>
                    <li>3x R$416,00 até dia 12/03</li>
                    <li>2x R$624,00 após dia 12/03</li>
                </ul>
            </li>
        </ul>
</p>
<p style='text-align: justify;text-justify: inter-word;'>
    ...
    Após dia 12/03, somente aceitaremos pagamento em PIX ou cartão de crédito.
</p>
...
<p style='text-align: justify;text-justify: inter-word;'>
    Serão concedidas bolsas, sob a forma de isenção de pagamentos, a pessoas em condição de vulnerabilidade socioeconômica, em quantidade equivalente a 10% das matrículas efetivadas, para o pagamento da matrícula e valor do curso.
</p>

### 3.1. Solicitação da Bolsa

<p style='text-align: justify;text-justify: inter-word;'>
    A solicitação de bolsa deve ser feita até dia 18/01/2026 através do preenchimento do formulário que pode ser encontrado abaixo:<br>
    <a href='https://forms.gle/6zR7gnDedqetR8xh7' target='_blank'>Formulário para solicitação de bolsas</a><br><br>
</p>
...
<p style='text-align: justify;text-justify: inter-word;'>
    ...
    A documentação será analisada pela coordenação do curso, e a classificação para a concessão das bolsas será divulgada por e-mail e em um post aqui no site do curso até 12/02/2026. O número de bolsas concedidas corresponderá a 10% do total de alunos matriculados, com um limite máximo de 45 bolsas.<br><br>
