...
<p style='text-align: justify;text-justify: inter-word;'>
    Neste <i>post</i> apresentamos os professores que ministrarão as disciplinas do curso <strong>Estatística e Otimização para Ciência de Dados e Pesquisa Operacional</strong>. Ambos são do <a href='https://www.icmc.usp.br' target="_blank">ICMC-USP</a>.
</p><br>
